...
public class UserInterfaceImpl implements IUserInterfaceContract.View, EventHandler<KeyEvent> {
        ...
        private final Group root;   // container

        //how do we keep track of anyone different text field?
        //reference variable for every textField is bad way
        //use a HashMap to retrieve and store
    ...
    //The Key (<Key, Value> -> <Coordinates, Integer>) will be the HashCode of a given InputField for ease of lookup
        ...
        //control logic class to interpret the events of typing
        ...
        private static final String SUDOKU = "Sufoku";
    ...
    //assign buildLogic class to this particular View
    @Override
    public void setListener(IUserInterfaceContract.EventListener listener){
        this.listener = listener;
    }
    //Helper method to avoid giant methods
    ...
    private void drawGridLines(Group root) {
        //draw vertical lines starting at 114x and 114y in the while loop:
        int xAndY = 114;
        int index = 0;
        while (index < 8) {
            int thickness;
    ...
    /**
     * Helper method for styling a com.sudoku tile number
     * @param tile
     * @param x
     * @param y
     */
    ...
    /**
     * Background of the actual com.sudoku board, offset from the window by BOARD_PADDING
     * @param root
     */
