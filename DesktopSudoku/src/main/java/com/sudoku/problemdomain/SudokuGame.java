...
//Serializable helps read the application
public class SudokuGame implements Serializable {
    ...
    /**
     * I suppose that the most fundamental states required to represent a com.sudoku game, are an active state and a
     ...
     *                  - GameState.Active
     *
     * @param gridState The state of the com.sudoku game. If certain conditions are met (all locations in the gridstate
    ...
    //return copy of GridState (inmutable) - protect object from being tampered with
